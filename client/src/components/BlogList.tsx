...
export default function BlogList() {
  ...
  return <main className="min-h-screen bg-[#f6fafc] pb-20">
    <header className="bg-gradient-to-br from-[#003F7D] via-[#006B9A] to-[#00B8C8] px-4 pb-20 pt-16 text-white">
      <div className="container"><a href="/planeatuviaje/" className="text-sm font-semibold text-white/80 hover:text-white">← Volver a Viajes Casal</a><div className="mt-12 max-w-3xl"><p className="text-xs font-bold uppercase tracking-[0.2em] text-[#9ef4ef]">Blog Viajes Casal</p><h1 className="mt-3 text-4xl font-extrabold leading-tight sm:text-6xl">Viaja mejor desde la planeación</h1><p className="mt-5 max-w-2xl text-base leading-relaxed text-white/80 sm:text-lg">Guías claras, comparaciones honestas y consejos prácticos para elegir destinos, cuidar tu presupuesto y disfrutar cada etapa del viaje.</p></div>
