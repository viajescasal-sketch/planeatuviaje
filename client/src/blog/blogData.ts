...
export type BlogArticle = {
  ...
  date: string; isoDate: string; readingTime: string; sections: BlogSection[];
};
...
export const blogArticles: BlogArticle[] = [
  {
    ...
    seoTitle: "Mejores Playas de Cancún para Familias en 2026",
    keyword: "mejores playas de Cancún para familias",
    description: "Descubre cuáles son las mejores playas de Cancún para ir con niños, con aguas tranquilas tipo alberca, y cómo visitarlas sin complicaciones. Guía 2026.",
    ...
    imageAlt: "Playa de arena blanca y agua turquesa en Cancún para disfrutar en familia", date: "10 de julio de 2026", isoDate: "2026-07-10", readingTime: "6 min",
    sections: [
  ...
  },
  {
    ...
    title: "Qué hacer en Puerto Vallarta: guía para tu primera vez", seoTitle: "Qué Hacer en Puerto Vallarta: Guía de Primera Vez",
    ...
    imageAlt: "Costa tropical del Pacífico mexicano cerca de Puerto Vallarta", date: "9 de julio de 2026", isoDate: "2026-07-09", readingTime: "6 min",
    sections: [
  ...
  },
  {
    ...
    imageAlt: "Formaciones rocosas y mar azul en la costa de Los Cabos", date: "8 de julio de 2026", isoDate: "2026-07-08", readingTime: "6 min",
    sections: [
  ...
  },
  {
    ...
    title: "Cómo planear un viaje a la playa por primera vez", seoTitle: "Cómo Planear un Viaje a la Playa por Primera Vez",
    keyword: "cómo planear un viaje a la playa por primera vez", description: "¿Es tu primera vez organizando vacaciones? Aprende a planear un viaje a la playa paso a paso y evita errores frecuentes. Guía sin errores.",
    ...
    imageAlt: "Viajeros contemplando una playa tropical durante sus primeras vacaciones", date: "7 de julio de 2026", isoDate: "2026-07-07", readingTime: "7 min",
    sections: [
  ...
  },
  {
    ...
    title: "Paquetes todo incluido vs. viajar por separado", seoTitle: "Paquetes Todo Incluido vs. Viajar por Separado",
    keyword: "paquetes todo incluido vs viajar por separado", description: "Comparamos paquetes todo incluido y reservas separadas para ayudarte a evaluar precio, cargos, tiempo y flexibilidad antes de reservar.",
    ...
    imageAlt: "Resort frente al mar representando un paquete de vacaciones todo incluido", date: "6 de julio de 2026", isoDate: "2026-07-06", readingTime: "7 min",
    sections: [
